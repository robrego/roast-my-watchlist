...
export default function Home() {
  ...
  return (
    <main style={{
      ...
      filter: dimmed ? "brightness(0.4)" : "brightness(1)",
    }}>

      {/* Language toggle */}
      <div style={{ position: "fixed", top: 24, right: 32, display: "flex", gap: 8, zIndex: 100 }}>
        {(["en", "it"] as const).map((l) => (
          <button
            ...
            style={{
              ...
              background: lang === l ? "rgba(180,83,9,0.1)" : "rgba(0,0,0,0.6)",
      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", width: "100%" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 13, letterSpacing: "0.35em", color: "#b45309", textTransform: "uppercase", fontFamily: "system-ui", margin: "0 0 20px" }}>
            {t.service}
          </p>
          <h1 style={{ fontSize: "clamp(40px, 6vw, 72px)", fontWeight: "bold", color: "white", margin: 0, lineHeight: 1.05 }}>
            {t.title}
          </h1>
          <p style={{ color: "#71717a", fontFamily: "system-ui", fontSize: 18, maxWidth: 480, margin: "24px auto 0", lineHeight: 1.9 }}>
            {t.subtitle.split("\n").map((line, i) => (
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, letterSpacing: "0.25em", color: "#52525b", marginBottom: 28, textTransform: "uppercase", fontFamily: "system-ui", marginTop: 0 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 28 }}>
            ...
            {canAddSlot && (
              ...
              >
                ...
                <span>{lang === "it" ? "Aggiungi film" : "Add film"}</span>
              </button>
            )}
          </div>
        </div>
