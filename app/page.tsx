      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", width: "100%" }}>
        ...
        <div style={{
          ...
          <h1 style={{ margin: 0, lineHeight: 1.05 }}>
            <span style={{ display: "block", fontSize: "clamp(36px, 5.5vw, 68px)", fontWeight: "bold", color: "white" }}>
              {t.title[0]}
            </span>
          ...
          <p style={{ color: "#71717a", fontFamily: "system-ui", fontSize: "clamp(14px, 2vw, 18px)", maxWidth: 480, margin: "24px auto 0", lineHeight: 1.9 }}>
            {t.subtitle.split("\n").map((line, i) => (
